...
const UserLogin = () => {
  ...
  const [isPasswordVisible, setPasswordVisibility] = useState(false); // State to manage password visibility
              ...
              <div>
                ...
                <div className="relative flex items-center mb-4">
                  ...
                  <svg
                    ...
                    viewBox="0 0 128 128"
                    onClick={() => setPasswordVisibility(!isPasswordVisible)} // Toggle visibility on icon click
                  >
